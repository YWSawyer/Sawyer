...
- (void)viewWillLayoutSubviews {
    ...
    frame.origin.x = 0.0;
    frame.origin.y = self.tabLocation ? 24.0 : self.view.frame.size.height - self.tabHeight;
    ...
    frame.origin.x = 0.0;
    frame.origin.y = self.tabLocation ? self.tabHeight+24 : 0.0;
    frame.size.width = self.view.bounds.size.width;
    frame.size.height = self.view.frame.size.height - self.tabHeight-24;
